                        ...
                        <div className="col-md-8">
                            ...
                            <article className="blog-post">
                                ...
                                <p>This blog post shows a few different types of content that’s supported and styled with
                                    ...
                                    expected.</p>
                                <hr/>
                                <p>This is some additional paragraph placeholder content. It has been written to fill
                                ...
                                <p>This is some additional paragraph placeholder content. It has been written to fill
                                    ...
                                    lookout for this exact same string of text.</p>
                                <h3>Example lists</h3>
                                <p>This is some additional paragraph placeholder content. It's a slightly shorter
                                    version of the other highly repetitive body text used throughout. This is an example
                                    unordered list:</p>
                                <ul>
                                ...
                                <ul>
                                    ...
                                    <li>Abbreviations, like <abbr title="HyperText Markup Langage">HTML</abbr> should
                                        use <code className="language-plaintext highlighter-rouge">&lt;abbr&gt;</code>,
                                        with an optional <code
                                            className="language-plaintext highlighter-rouge">title</code> attribute for
                                        the full phrase.
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        should use <code
                                        className="language-plaintext highlighter-rouge">&lt;ins&gt;</code>.
                                    </li>
